            ...
            <div class="container-fluid">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable">
                        ...
                        <!--
                        <tr>
                            <c:forEach var="detai" items="${listdetai}" varStatus="status">
                        <tr>
                            <td>${status.index + 1}</td>
                            <td name="MaDT" value="${detai.maDT}">${detai.maDT}</td>
                            <td>${detai.tenDeTai}</td>
                            <td>${detai.giangvien.tenGV}</td>
                            <td>${detai.trangthai.tenTrangThai}</td>
                            <td>
                                <a href="Xemchitietdetai?MaDT=<c:out value='${detai.maDT}' />"
